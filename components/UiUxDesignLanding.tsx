...
const UIUXDesignLanding: React.FC = () => {
  ...
  const services = [
    {
      ...
      description: "Clean, modern, and visually engaging interfaces.",
    },
    {
      icon: <LayoutTemplate className="h-6 w-6" />,
      title: "User Experience (UX) Design",
      description: "Intuitive flows that improve usability and engagement.",
    },
    {
      icon: <Palette className="h-6 w-6" />,
      title: "Brand & Visual Design",
      description: "Consistent design systems aligned with your brand.",
    },
    {
    ...
    },
    {
      ...
      description: "Designing digital products users love to use.",
    },
    {
      icon: <Monitor className="h-6 w-6" />,
      title: "Prototyping & Wireframing",
      description: "Interactive mockups before development.",
    },
  ];
  ...
  const trustIndicators = [
    { icon: <Award className="h-8 w-8" />, text: "Expert Designers" },
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-linear-to-br from-purple-900 via-indigo-800 to-blue-900 flex items-center justify-center px-4">
        <div className="bg-white p-12 rounded-2xl shadow-2xl text-center max-w-xl relative">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Thanks for contacting us about your UI/UX design project. We will
            reach out soon!
          </p>

          <p className="text-sm text-gray-500">
            Urgent inquiries: +2349038979339
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-linear-to-br from-purple-900 via-indigo-800 to-blue-900 py-20">
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <div className="inline-flex items-center bg-pink-500/20 text-pink-200 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  User-Centered & Conversion-Focused Design
                </div>

                <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                  UI/UX <span className="text-yellow-400">Design</span>
                </h1>

                <p className="text-xl text-indigo-100 mb-8">
                  We design intuitive, engaging, and high-converting digital
              ...
              <div className="sticky top-8">
                <div className="bg-white rounded-2xl shadow-2xl p-8 border-4 border-yellow-400">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Get My UI/UX Quote"}
                    </button>
                  </form>

                  {/* BIO stays EXACTLY same */}
...
export default UIUXDesignLanding;
