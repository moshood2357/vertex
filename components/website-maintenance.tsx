        ...
        <div className="container mx-auto py-28 px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              our ongoing maintenance and technical support services.
            </p>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl bg-white p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">
                Continuous monitoring, updates, and protection
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              We ensure your website remains fast, secure, and fully functional
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <ul className="space-y-5 text-slate-600">
                <li className="flex items-start gap-3">
                  ...
                  Core updates & plugin maintenance
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  Regular backups & recovery setup
                </li>
            ...
            <div className="relative w-full h-72 md:h-96">
              <Image
                src="/landscape.png"
                alt="Website maintenance and support services"
                fill
      ...
      <section className="py-24 bg-[#0B1F3B] text-white text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Let Vertex Prime Digital handle your website maintenance while you
