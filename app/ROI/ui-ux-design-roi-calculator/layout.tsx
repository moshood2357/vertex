...
export const metadata: Metadata = {
  title:
    "UI/UX Design ROI Calculator — Measure the Value of Better Design | Lagos",
  description:
  ...
  twitter: {
    ...
    title: "UI/UX Design ROI Calculator",
    description: "Free tool to calculate UX ROI for your business.",
  },
